...
WHERE (priority.id = '1' OR priority.id = '2') AND changelog_history_item.field = 'status' AND changelog_history_item.from_string = 'Open' AND changelog_history_item.to_string = 'Closed' AND attachment.attachment_type IS NOT NULL
