...
func main() {
	...
	case "fields_complexity":
		...
		break
	case "all":
		funcs = append(funcs, plot.CommentsComplexity, plot.FieldsComplexity, plot.SentimentAnalysis,
			plot.GrammarCorrectness, plot.Stacktraces, plot.StepsToReproduce, plot.Attachments)
		break
	default:
